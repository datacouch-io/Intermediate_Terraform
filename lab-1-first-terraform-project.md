...
Prerequisite: [`00-shared-setup.md`](00-shared-setup.md) completed.
...
[`00-shared-setup.md` §6](00-shared-setup.md) and terminate by instance ID.
...
5. **Re-measure the price.** The `$0.0104/hr` in §2.3 is a snapshot from 2026-09-05. Re-run the
   Pricing API query in [`00-shared-setup.md` §7](00-shared-setup.md) for your own region and check
