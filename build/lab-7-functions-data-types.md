...
Prerequisites: [`00-shared-setup.md`](00-shared-setup.docx), Labs 1–6.
...
> **`lookup()` here is a legitimate use, unlike Lab 5's.** In [Lab 5](lab-5-modules-workspaces.docx) a
...
**Use `count` for "give me N of these".** [Lab 8](lab-8-loops-backends.docx) does exactly that, and it
