...
Prerequisites: [`00-shared-setup.md`](00-shared-setup.docx), Labs [1](lab-1-first-terraform-project.docx)
and [2](lab-2-variables-locals-data-sources.docx).
...
[`00-shared-setup.md` §6](00-shared-setup.docx).
