...
Prerequisites: [`00-shared-setup.md`](00-shared-setup.docx), Labs 1–7 — **especially
[Lab 7](lab-7-functions-data-types.docx)**, whose `count` versus `for_each` comparison this lab
depends on.
...
[Lab 6](lab-6-error-handling-debugging.docx).
...
> **`count` versus `for_each`, decided properly.** [Lab 7](lab-7-functions-data-types.docx) measured
...
control — the thing [Lab 5](lab-5-modules-workspaces.docx) §4 Step 8 said workspaces do not give you.
...
3. **Use partial backend configuration.** Remove `bucket` and `key` from `backend.tf`, put them in
   ...
   [Lab 5](lab-5-modules-workspaces.docx) §4 Step 8 recommends.
